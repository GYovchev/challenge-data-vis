...
module.exports = createReactClass({
  ...
  injectOffsetsIntoData (data){
    ...
    data.forEach((d, idx) => {
    d.i = idx,
    d.offset = {left: linmap(minPetalWidth, maxPetalWidth, 0, this.props.width, d.petalWidth ),
                top: this.props.height - linmap(minPetalLength, maxPetalLength, 0, this.props.height, d.petalLength )}
    })
